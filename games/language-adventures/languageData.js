export const SCENARIOS = [
  { id:'home', title:'At Home', icon:'🏠', tone:'coral', art:'../scenes/toy-room.png', cardArt:'cards/home.png', subtitle:'Little helpers make a big difference.', steps:[
    { phrase:'Let’s tidy up!', prompt:'Tap the toy box.', type:'tap', activity:'tidy-room', target:'toybox', position:[69,70], success:'Great helping!' },
