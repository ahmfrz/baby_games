...
export const SCENARIOS = [
  ...
  { id:'park', title:'In the Park', icon:'🌳', tone:'green', art:'scenes/park.webp', cardArt:'cards/park.webp', subtitle:'Notice, share, and make a new friend.', steps:[
  ...
  { id:'school', title:'At School', icon:'🎒', tone:'blue', art:'school-friend.webp', cardArt:'cards/school.webp', subtitle:'Learn, listen, and help your friends.', steps:[
  ...
  { id:'world', title:'Around the World', icon:'🌍', tone:'orange', art:'hero-explorer.webp', cardArt:'cards/world.webp', subtitle:'Explore new places and meet new friends.', steps:[
